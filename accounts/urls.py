...
urlpatterns = [
    ...
    path("admin-panel/reports/", views.admin_view_report, name="admin_view_report"),
    path("admin-panel/reports/download/", views.admin_download_report, name="admin_download_report"),
    path("admin-panel/reports/<int:branch_id>/", views.admin_view_branch_report, name="admin_view_branch_report"),
    path("admin-panel/reports/download/<int:branch_id>/", views.admin_download_branch_report, name="admin_download_branch_report"),
    ...
    path("manager/reports/view/", views.manager_view_report, name="manager_view_report"),
    path("manager/reports/download/", views.download_report, name="download_report"),
